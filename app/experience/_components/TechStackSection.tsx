...
export const TechStackSection = () => {
	...
	return (
		<section className='px-4 mx-auto max-w-screen-lg w-full mt-20 text-white'>
			<h1 className='font-semibold text-3xl md:text-5xl text-center'>Tech Stack</h1>
			...
			<p className='text-justify mt-8'>
				{language === 'en' ? (
					<>
						...
						databases like <span className='highlighted'>MongoDB</span> and{' '}
						<span className='highlighted'>relational databases using NodeJS</span>, providing me with a
					...
					<>
						...
						<span className='highlighted'>MongoDB</span> quanto com bancos de dados relacionais usando{' '}
						<span className='highlighted'>NodeJS</span>, proporcionando-me uma capacidade de desenvolvimento
						full-stack.
					</>
				)}
			</p>
